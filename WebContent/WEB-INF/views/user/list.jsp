	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="idCard" class="wu-text easyui-validatebox"data-options="required:true, missingMessage:'请填写身份证号'" /></td>
            </tr><tr>
                <td width="60" align="right">手机号:</td>
                <td><input type="text" name="mobile" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写手机号'"/></td>
            </tr><tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <tr>
                <td width="60" align="right">身份证号:</td>
                <td><input type="text" id="edit-idCard" name="idCard" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'填写身份证号'"/></td>
            </tr><tr>
                <td width="60" align="right">手机号:</td>
                <td><input type="text" id="edit-mobile" name="mobile" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写手机号'"/></td>
            </tr><tr>
                <td width="60" align="right">真实姓名:</td>
                <td><input type="text"id="edit-realName"  name="realName" class="wu-text easyui-validatebox"data-options="required:true, missingMessage:'请填写姓名'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">年龄:</td>
