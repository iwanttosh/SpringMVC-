...
<body>
  ...
  <header>
    <div>
      <a href="">
      	<img src="../resources/home/images/logo-2.jpg" alt=""  height="160px" width="260px"> 
      </a>
       <span>自助餐厅注册界面</span>
    </div>
  ...
  <div id="reg">
    ...
    <form id="user_info">
      ...
      <div class="form-group">
        <label for="urealName">真实姓名：</label>
        <input required type="text" placeholder="请输入姓名" name="realName" id="urealName"/>
        <span class="msg-default hidden">请输入真实姓名</span>
      </div>
      <div class="form-group">
